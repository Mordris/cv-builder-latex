        ...
        >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <InputField
              ...
              @update:modelValue="updateItem(index, 'degree', $event)"
              placeholder="e.g., B.S. Computer Science"
            />
            <InputField
              label="Institution"
              :modelValue="item.institution"
              @update:modelValue="updateItem(index, 'institution', $event)"
            ...
            <InputField
              ...
              placeholder="e.g., 2016 - 2020 or Graduated 2020"
            />
            ...
            <TextareaField
              ...
              placeholder="e.g., Minor in Mathematics, GPA: 3.8, Thesis topic..."
              rows="3"
              class="md:col-span-2"
            />
          </div>
